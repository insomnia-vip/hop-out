...
Missing values must remain unknown. Do not silently choose a different pool, replace live failures with demo values, or add wallet signing to the current product flow. Never include credentials in fixtures or issues.
